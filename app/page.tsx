...
export default function Home(){
  return <main>
    ...
    <section className="brand-architecture section-wrap"><div className="section-heading split"><div><p className="eyebrow">One ecosystem · two jobs</p><h2>The seed bank<br/>and the notebook.</h2></div><p>CannaCore is the genetics studio. JJ’s Stash is the editorial record around it. Keeping those roles distinct gives the commercial catalog a focused identity while letting the research, history, and culture become a deeper destination of their own.</p></div><div className="brand-duo"><article><span>01 / Genetics studio</span><h3>CannaCore Seeds</h3><p>Genetic library, breeder releases, collection discovery, pack availability, and the commercial side of the brand.</p><Link href="/genetics">Explore genetics ↗</Link></article><article className="stash-card"><span>02 / Publication</span><h3>JJ’s Stash</h3><p>Genetics research, plant science, cultivation notes, history, culture, and the public notebook behind the library.</p><a href={site.stashUrl} target="_blank" rel="noreferrer">Read on Beehiiv ↗</a></article></div></section>

    <CultureSpotlight/>
    <StashPreview/>

    <section className="founder-band"><div><p className="eyebrow">The through-line</p><h2>The seed bank and the notebook come from the same obsession: understanding what is actually inside the plant.</h2></div><div><p>JJ’s Stash is not a second seed company. It is the editorial voice around CannaCore — a place to document selection, biology, cultivar history, preservation, and the culture that made the genetics matter in the first place.</p><Link href="/about" className="text-link">Read the brand story <span>↗</span></Link></div></section>
  </main>
}