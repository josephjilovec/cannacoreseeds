export function CultureSpotlight(){
  const media = [
    ...
    { name:'STRAIN SHOW', note:'Education · science · grow culture', href:'https://www.strainshow.com/', icon:'https://www.google.com/s2/favicons?domain=strainshow.com&sz=128' },
