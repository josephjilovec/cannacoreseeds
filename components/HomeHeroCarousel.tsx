...
const slides = [
  {image:'https://images.pexels.com/photos/5810703/pexels-photo-5810703.jpeg?auto=compress&cs=tinysrgb&w=2200', eyebrow:'CannaCore Seeds × JJ’s Stash', title:'Genetics with', emphasis:'a paper trail.', copy:'A genetics studio built around documented lineage, deliberate selection, and a public notebook that explains what sits behind every release.', primary:'/genetics', primaryLabel:'Explore genetics', secondary:'/stash', secondaryLabel:'Enter JJ’s Stash', label:'Cultivation / greenhouse', detail:'Controlled environment'},
