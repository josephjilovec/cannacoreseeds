...
<div className="footer-grid">
      ...
      <div><p>Explore</p><Link href="/genetics">Genetics</Link><Link href="/stash">JJ’s Stash</Link><Link href="/about">Brand story</Link><Link href="/contact">Contact</Link></div>
      <div><p>JJ’s Stash</p><a href={site.stashUrl} target="_blank" rel="noreferrer">Newsletter ↗</a><a href={site.stashArchive} target="_blank" rel="noreferrer">Archive ↗</a><a href={site.stashAuthors} target="_blank" rel="noreferrer">About the author ↗</a></div>
    </div>
